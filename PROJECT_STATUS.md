...
## Phase 5.5: 记忆生命周期管理 ✅ 完成 (2026-03-22)

**新增认知模块** (`src/memorybridge/cognitive/`):

### MemoryRefiner (记忆提炼器)
- ✅ 重要性评分算法（引用次数、用户指令、情感强度、时效性）
- ✅ Short-term → Long-term 自动升级
- ✅ 记忆合并去重
- ✅ 过期记忆清理

### KnowledgeGraphExtractor (知识图谱提取器)
- ✅ 从对话自动提取实体和关系
- ✅ 时间维度追踪（created_at, updated_at, expires_at）
- ✅ 关系置信度管理（随时间衰减）
- ✅ 知识新鲜度报告
